...
# from jaxrl2.utils.visualization_utils import sigmoid # TODO: bring this back?

traj_group_put_blueberries_on_plate_sink = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen6/put_blueberries_on_plate_sink/*/raw/traj_group*/traj*')
traj_group_take_cup_off_plate = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen6/take_cup_off_plate/*/raw/traj_group*/traj*')


traj_group_open = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam/toykitchen1/open_microwave/*/raw/traj_group*/traj*')
traj_group_close = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam/toykitchen1/close_microwave/*/raw/traj_group*/traj*')
traj_group_sushi = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam/toykitchen2/put_sushi_in_pot_cardboard_fence/*/raw/traj_group*/traj*')
traj_group_sushi_out = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam/toykitchen2/take_sushi_out_of_pot_cardboard_fence/*/raw/traj_group*/traj*')
traj_group_bowlplate = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam/toykitchen2/put_bowl_on_plate_cardboard_fence/*/raw/traj_group*/traj*')
traj_group_cornbowl = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam/toykitchen6/put_corn_in_bowl_sink/*/raw/traj_group*/traj*')
traj_group_cup_plate = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam/toykitchen6/put_cup_on_plate/*/raw/traj_group*/traj*')
traj_group_corn_out_bowl = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam/toykitchen6/take_corn_out_of_bowl_sink/*/raw/traj_group*/traj*')
traj_group_knife_pot = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6/put_knife_into_pot/2022-06-15_13-58-35/raw/traj_group*/traj*')
traj_group_croissant_pot = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6/take_croissant_out_of_pot/2022-06-15_13-38-29/raw/traj_group*/traj*')
traj_group_pot_sink = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam/berkeley/toykitchen1/put_pot_in_sink/2021-06-08_20-18-29/raw/traj_group*/traj*')
traj_group_take_carrot_plate = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam/berkeley/toykitchen1/take_carrot_off_plate/*/raw/traj_group*/traj*')
traj_group_put_sushi_on_plate = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam/berkeley/toykitchen1/put_sushi_on_plate/*/raw/traj_group*/traj*')


traj_group_put_carrot_on_plate = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toysink2_bww/put_carrot_on_plate/*/raw/traj_group*/traj*')
traj_group_put_eggplant_into_pot_or_pan = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toysink2_bww/put_eggplant_into_pot_or_pan/*/raw/traj_group*/traj*')
traj_group_put_spoon_in_pot = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toysink2_bww/put_spoon_in_pot/*/raw/traj_group*/traj*')
traj_group_flip_pot_upright_which_is_in_sink = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toysink2_bww/flip_pot_upright_which_is_in_sink/*/raw/traj_group*/traj*')
# traj_group_put_eggplant_into_pot_or_pan = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toysink2_bww/put_cup_from_counter_or_drying_rack_into_sink/*/raw/traj_group*/traj*')

traj_group_put_cup_from_counter_or_drying_rack_into_sink = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toysink2_bww/put_cup_from_counter_or_drying_rack_into_sink/*/raw/traj_group*/traj*')



traj_group_tk6_task1 = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6/put_knife_into_pot/*/raw/traj_group*/traj*')
traj_group_tk6_task2 = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6/take_croissant_out_of_pot/*/raw/traj_group*/traj*')
traj_group_tk6_task3 = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6/take_pear_from_plate/*/raw/traj_group*/traj*')
traj_group_tk6_task4 = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6/put_sweet_potato_in_bowl/*/raw/traj_group*/traj*')
traj_group_tk6_task5 = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6/put_lime_in_pan_sink/*/raw/traj_group*/traj*')
traj_group_tk6_task6 = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6/put_sweet_potato_on_plate/*/raw/traj_group*/traj*')
traj_group_tk6_task7 = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6/put_drumstick_on_plate/*/raw/traj_group*/traj*')
traj_group_tk6_task8 = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6/put_cucumber_in_orange_pot/*/raw/traj_group*/traj*')
traj_group_tk6_task9 = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6/put_carrot_in_pan/*/raw/traj_group*/traj*')
traj_group_tk6_task10 = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6/put_big_corn_in_big_pot/*/raw/traj_group*/traj*')

traj_group_tk6_put_cucumber_pot_elevated = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6_elevated/put_cucumber_in_orange_pot/*/raw/traj_group*/traj*')
traj_group_tk6_put_cucumber_pot_elevated_rotated = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6_rotated_elevated/put_cucumber_in_orange_pot/*/raw/traj_group*/traj*')
traj_group_tk6_take_croissant_elevated = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6_elevated/take_croissant_out_of_pot//*/raw/traj_group*/traj*')
traj_group_tk6_take_croissant_rotated = glob.glob('/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_targetdomain/berkeley/toykitchen6_rotated/take_croissant_out_of_pot//*/raw/traj_group*/traj*')


start_transforms = dict(
    right_front = ['/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_initial_testconfig/rss_benchmark/toykitchen1/put_broccoli_in_pot/2022-01-22_11-06-56/raw/traj_group0/traj0', 150],
    middle = ['/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_initial_testconfig/rss_benchmark/toykitchen1/put_broccoli_in_pot/2022-01-22_11-06-56/raw/traj_group0/traj1', 290],
    left_front = ['/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_initial_testconfig/rss_benchmark/toykitchen1/put_broccoli_in_pot/2022-01-22_11-06-56/raw/traj_group0/traj2', 200],
    left_rear = ['/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_initial_testconfig/rss_benchmark/toykitchen1/put_broccoli_in_pot/2022-01-22_17-54-21/raw/traj_group0/traj0', 290],
    right_rear = ['/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam_initial_testconfig/rss_benchmark/toykitchen1/put_broccoli_in_pot/2022-01-22_17-54-21/raw/traj_group0/traj1', 290],

    openmicrowave = ['/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam/toykitchen1/open_microwave/2021-12-01_16-14-39/raw/traj_group0/traj0', 7],
    closemicrowave = ['/iris/u/moojink/rt1_widowx/data/berkeley/toykitchen_fixed_cam/toykitchen1/close_microwave/2021-12-02_12-14-59/raw/traj_group0/traj1', 0],
    ...
    reaching = ['/iris/u/moojink/rt1_widowx/data/berkeley/online_datacollection/online_reaching/berkeley/toykitchen1/pix_policy_std0.3_initscale0.0_collectdata/2022-04-25_18-10-03/raw/traj_group0/traj0', 0],
    ...
    toykitchen6_put_blueberries_on_plate_sink= [traj_group_put_blueberries_on_plate_sink, (0, 1)],
    toykitchen6_take_cup_off_plate= [traj_group_take_cup_off_plate, (3, 7)],
    ...
    toysink2_put_carrot_on_plate = [traj_group_put_carrot_on_plate, (0, 1)],
    toysink2_put_eggplant_into_pot_or_pan = [traj_group_put_eggplant_into_pot_or_pan, (0, 1)],
    toysink2_put_spoon_in_pot = [traj_group_put_spoon_in_pot, (0, 1)],
    toysink2_flip_pot_upright_which_is_in_sink = [traj_group_flip_pot_upright_which_is_in_sink, (0, 1)],


    toysink2_put_cup_from_counter_or_drying_rack_into_sink = [traj_group_put_cup_from_counter_or_drying_rack_into_sink, (0, 1)],
...
class BridgeDataJaxRLWidowXRewardAdapter(JaxRLWidowXEnv):
    ...
    def infer_reward_for_task(self, obs, task_id):
        ...
        # reward = sigmoid(reward) # TODO: bring this back
        print('Warning (TODO): missing sigmoid function.')

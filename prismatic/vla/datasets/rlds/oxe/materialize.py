...
def make_oxe_dataset_kwargs(
    ...
    if dataset_kwargs["action_encoding"] is not ActionEncoding.EEF_POS:
        raise ValueError(f"Cannot load `{dataset_name}`; only EEF_POS actions supported!")

    # [Contract] For EEF_POS actions, only the last action dimension (gripper) is absolute!
